...
class SetCardView: UIView {
    ...
    // draw rectagle with rounded corners, adjust its borders and draw
    // either front side of the card with the Set game symbols using the
    // drawPips() method, or the back side of the card
    ...
    // Depending on the number of characters on the count map draw 1,2,3 respectively
    ...
    // Depending on the type of symbol, draw squiggle, diamond, or oval, and the filling type
    ...
    // draw the squiggle as a combination of 3 cubic Bezier curves
    // and rotating of 180 degree
    ...
    */
    ...
    // the scalling of pin depending on the size of the SetCardView map
